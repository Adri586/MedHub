    ...
    <div class="container">
        ...
        {elseif $config.customerType == "medical_staff"}
            ...
            <div class="col-md-9">
                ...
                <p>Wir bieten ihnen und ihren Patienten einen einfachen und sicheren Weg, den Überblick im
                    Tablettenjungle
                    zu behalten.</p>
                <br>
                <p>Sparen sie Zeit und Geld bei der Erstellung von Rezepten. Nutzen sie unsere Datenbank zum
                    automatischen
                    Vergleich von Wechselwirkung und Verordnungsrichtlinien.</p>
                <p>Schaffen sie Freiräume, um wieder mehr Zeit für das persönliche Gespräch mit ihren Patienten zu
                    haben.
                    Unsere BSI zertifizierte Plattform und Anwendung schafft maximale Sicherheit und Übersicht und
                    bietet
                    Ihnen und Ihrem Praxisteam die Möglichkeit, zeiteffizient zu arbeiten. Dabei steht stets der Mensch
                    und
