    ...
    <div class="container">
        ...
        {if $config.customerType == "patient"}
            ...
            <p>Morgens 100 mg, abends 200 mg. Mittags zwei Tabletten von diesem Medikament, alle drei Tage jenes…
                ...
                Lassen sie uns ihnen helfen! {$config.pageName} bietet eine leicht verständliche und sichere Unterstützung im Alltag.
        ...
        {elseif $config.customerType == "medical_staff"}
            ...
            <p> Wechselwirkungen? Verfügbarkeit? Einnahmesicherheit?
                ...
                Wir bieten ihnen und ihren Patienten einen einfachen und sicheren Weg, den Überblick im Tablettenjungle zu behalten. {$config.pageName}.
